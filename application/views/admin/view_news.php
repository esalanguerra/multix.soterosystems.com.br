...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/news/add" class="btn btn-primary btn-sm">Adicionar Nova</a>
	</div>
</section>
							...
							foreach ($news as $row) {
								...
								<tr>
									...
									<td>										
										...
										<a href="<?php echo base_url(); ?>admin/news/delete/<?php echo $row['news_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Deletar</a>  
									</td>
								</tr>
								<?php
							}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Você quer mesmo deletar este item?</p>
            </div>
