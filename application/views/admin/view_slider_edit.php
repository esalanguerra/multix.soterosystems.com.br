						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="position" class="form-control select2">
									<option value="Left" <?php if($slider['position'] == 'Left') {echo 'selected';} ?>>Esquerda</option>
									<option value="Right" <?php if($slider['position'] == 'Right') {echo 'selected';} ?>>Direita</option>
								</select>
							</div>
						</div>
						<div class="form-group">
