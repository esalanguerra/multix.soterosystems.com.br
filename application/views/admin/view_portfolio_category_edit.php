...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar Categoria do Portifólio</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/portfolio_category" class="btn btn-primary btn-sm">Visualizar Todos</a>
	</div>
</section>
	                ...
	                <div class="form-group">
			            ...
			            <div class="col-sm-4">
			            	<select name="status" class="form-control select2">
			            		<option value="Active" <?php if($portfolio_category['status']=='Active') {echo 'selected';} ?>>Ativado</option>
			            		<option value="Inactive" <?php if($portfolio_category['status']=='Inactive') {echo 'selected';} ?>>Desativado</option>
			            	</select>
			            </div>
			        </div>
	                <div class="form-group">
