          ...
          <table id="example1" class="table table-bordered table-striped">
			<thead>
			    <tr>
			        <th width="50">N°</th>
			        <th>Título da FAQ </th>
			        <th>Visualizar na Pagina Principal?</th>
	            	...
	            	foreach ($faq as $row) {
			            ...
			            <tr>
			                ...
			                <td>
			                    ...
			                    <a href="<?php echo base_url(); ?>admin/faq/delete/<?php echo $row['faq_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Deletar</a> 
			                </td>
			            </tr>
			            <?php
	            	}
