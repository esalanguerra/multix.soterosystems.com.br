			...
			<?php echo form_open_multipart(base_url().'admin/news/add',array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Conteúdo da Notícia (curto) <span>*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Conteúdo da Notícia <span>*</span></label>
							<div class="col-sm-9">
								<textarea class="form-control editor" name="news_content"><?php if(isset($_POST['news_content'])) {echo $_POST['news_content'];} ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Data de Publicação da Notícia <span>*</span></label>
							<div class="col-sm-2">
								<input type="text" class="form-control" name="news_date" id="datepicker" value="<?php echo date('Y-m-d'); ?>">(Format: yy-mm-dd)
							</div>
						</div>						
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Selecionar Categoria <span>*</span></label>
				            <div class="col-sm-3">
				        ...
				        <div class="form-group">
				            <label for="" class="col-sm-2 control-label">Comente <span>*</span></label>
				            <div class="col-sm-3">
