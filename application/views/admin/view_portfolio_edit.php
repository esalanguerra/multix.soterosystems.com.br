...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/portfolio" class="btn btn-primary btn-sm">Visualizar Todos</a>
	</div>
</section>
			...
			<?php echo form_open_multipart(base_url().'admin/portfolio/edit/'.$portfolio['id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Empresa do Cliente</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Data do Término</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Foto Atualmente em Destaque</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(Only jpg, jpeg, gif e png)
							</div>
						</div>
								...
								<table class="table table-bordered">
									...
									foreach ($all_photos_by_id as $row) {
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url(); ?>admin/portfolio/single-photo-delete/<?php echo $row['id']; ?>/<?php echo $portfolio['id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Deletar</a>
											</td>
										</tr>
										<?php
									}
