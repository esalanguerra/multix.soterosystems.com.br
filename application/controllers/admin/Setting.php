	...
	public function update()
	{
		...
		if(isset($_POST['form_logo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Logo foi atualizado com sucesso!!';
		...
		if(isset($_POST['form_favicon'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Favicon foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_top_bar'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Top Bar Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_footer_general'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Footer General Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_footer_newsletter'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Footer Newsletter Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_footer_cta'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Footer Call to Action Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_footer_cta_background'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Call to Action Background photo foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_email'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Email Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_sidebar'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Sidebar Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_color'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Front End Color Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
		...
		if(isset($_POST['form_banner_about'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'About Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_faq'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'FAQ Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_service'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Service Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_testimonial'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Testimonial Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_news'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'News Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_event'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Event Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_contact'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Contact Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_search'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Search Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_terms'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Terms and Conditions Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_privacy'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Privacy Policy Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_team'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Team Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_portfolio'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Portfolio Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_verify_subscriber'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Verify Subscriber Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_pricing'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Pricing Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_banner_photo_gallery'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$this->Model_setting->update($form_data);
	        	$success = 'Photo Gallery Page Banner foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/setting');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_payment'])) {
        	...
        	$this->Model_setting->update($form_data);   	
        	$success = 'Payment Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/setting');
		}
