...
class Page extends CI_Controller 
{
	...
	public function update()
	{
		...
		if(isset($_POST['form_home'])) {
        	...
        	$success = 'Home page meta information foi atualizado com sucesso!!';
		...
		if(isset($_POST['form_home_welcome'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page welcome information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_welcome_video_bg'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Home page welcome video background foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		...
		if(isset($_POST['form_home_why_choose'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page why choose us information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_feature'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page feature information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_service'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page service information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_counter_text'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page counter information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_counter_photo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Home page counter photo foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_home_booking_photo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Home page booking photo foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_home_portfolio'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page portfolio information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_booking'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page booking information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_team'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page team information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_pricing_table'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page pricing table information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_testimonial'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page testimonial information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_home_testimonial_photo'])) {
		    ...
		    if($valid == 1) {
	        	...
	        	$success = 'Home page testimonial photo foi atualizado com sucesso!!';
		    	$this->session->set_flashdata('success',$success);
		    	redirect(base_url().'admin/page');
		    } else {
		    	$this->session->set_flashdata('error',$error);
		...
		if(isset($_POST['form_home_blog'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page blog information foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_about'])) {
        	...
        	$success = 'About Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_faq'])) {
        	...
        	$success = 'FAQ Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_service'])) {
        	...
        	$success = 'Service Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_testimonial'])) {
        	...
        	$success = 'Testimonial Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_news'])) {
        	...
        	$success = 'News Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_event'])) {
        	...
        	$success = 'Event Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_contact'])) {
        	...
        	$success = 'Contact Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_search'])) {
        	...
        	$success = 'Search Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_term'])) {
        	...
        	$success = 'Term Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_privacy'])) {
        	...
        	$success = 'Privacy Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_team'])) {
        	...
        	$success = 'Team Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_portfolio'])) {
        	...
        	$success = 'Portfolio Page Setting foi atualizado com sucesso!!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
